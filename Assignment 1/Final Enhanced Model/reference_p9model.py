...
import reference_p9agentframework # needed to access Agent class and methods.
...
for i in range(num_of_agents):
    y = int(td_ys[i].text)
    x = int(td_xs[i].text)
    agents.append(reference_p9agentframework.Agent(environment, agents, neighbourhood, y, x))
